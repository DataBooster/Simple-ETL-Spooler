...
(
    ...
    CONSTRAINT CK_UTIL_SYS_ETL_TASK_EXTRACT_P CHECK (EXTRACT_PARAMS IS JSON),
    CONSTRAINT CK_UTIL_SYS_ETL_TASK_FIELD_MAP CHECK (FIELD_MAPPING IS JSON),
    CONSTRAINT CK_UTIL_SYS_ETL_TASK_MERGE_PAR CHECK (MERGE_PARAMS IS JSON)
)
NOLOGGING;
